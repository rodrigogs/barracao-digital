...
const service = {
  async create(doctor) {
    ...
    return doctorsRepository.create({
      ...doctor, password, videoSessions: {}, textSessions: {},
    });
  },
  ...
  async addTextSession(doctorUsername, patientTicket) {
    console.info(`Adding text session for doctor "${doctorUsername}" with patient "${patientTicket}"`);
  ...
  async removeTextSession(doctorUsername, patientTicket) {
    console.info(`Removing text session for doctor "${doctorUsername}" with patient "${patientTicket}"`);
    return service.update(doctorUsername, {
      textSessions: {
