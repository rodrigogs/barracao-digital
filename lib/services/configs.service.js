...
const service = {
  ...
  async createVideoSession(doctorUsername, patientTicket) {
    ...
    const doctorToken = configsRepository.generateOpentokToken(videoSession.sessionId, { role: 'publisher' });
    const patientToken = configsRepository.generateOpentokToken(videoSession.sessionId, { role: 'publisher' });
