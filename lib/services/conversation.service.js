...
const service = {
  ...
  async removeSession(doctorUsername, patientTicket) {
    await service.removeVideoSession(doctorUsername, patientTicket);
    await service.removeTextSession(doctorUsername, patientTicket);
  },
  ...
  async removeTextSession(doctorUsername, patientTicket) {
    conversationRepository.removeTextSession(doctorUsername, patientTicket);
  },
};
