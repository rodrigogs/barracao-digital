...
const sendPushNotification = async (patientTicket, payload) => {
  try {
    ...
    var message = {
      token,
      notification: {
        title: payload.doctor,
        body: payload.message,
        image: 'https://www.barracaodigital.com/favicon/mstile-150x150.png',
      },
    };
