...
const validateStatus = (status) => {
  const statuses = ['waiting', 'ongoing', 'finished', 'waiting_kit', 'cant_be_assisted', 'shed_not_available'];
...
module.exports = {
  async create(patient) {
    ...
    // TODO verify if patient's cep has a shed. If not, set status to "shed_not_available"
