...
describe('#create', () => {
  it('Create a new patient', async () => {
    ...
    patient = await patientsRepository.getOneByTicket(saved.ticket)
...
describe('#update', () => {
  it('Update the created patient', async () => {
    ...
    patient = await patientsRepository.getOneByTicket(updated.ticket)
...
describe('#getAllByCep', () => {
  it('Get patients by CEP', async () => {
    ...
    expect(patients).toEqual(expect.arrayContaining([patient]))
  })
})
...
describe('#getAllByCepAndStatus', () => {
  it('Get patients by CEP and Status', async () => {
    ...
    expect(patients.length).toBeGreaterThan(0)
    expect(patients).toEqual(expect.not.arrayContaining([patient]))
  })
})
