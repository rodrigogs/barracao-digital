...
const repository = {
  ...
  async sendSmsMessageToPatient(patient) {
    await smsProvider.send(
      ...
      `Barracao Digital: Um medico esta pronto para lhe atender, retorne ao site ou app e use sua senha de retorno ${patient.ticket} para entrar, ou acesse o link https://web.barracaodigital.com/patient/${patient.ticket}`
    )
  },
}
